...
//
// Kit de widgets reutilizables que materializa los patrones del diseño.
// Estos son la base — las pantallas las componen para no duplicar lógica.

import 'package:flutter/material.dart';
import 'tokens.dart';

/// Card con borde por defecto, sin sombra. Usá [FzCard.paid] / [FzCard.late]
/// para los estados.
...
class FzBottomNav extends StatelessWidget {
  final int index; // 0=mes, 1=tarjetas, 2=config
...
/// AppBar con back button + título centrado-izquierda + slot derecho.
