...
class FzText {
  ...
  static const display = TextStyle(
    fontFamily: FzType.sans, fontSize: 36, fontWeight: FontWeight.w600,
    letterSpacing: -1.08, color: FzColors.text,
    fontFeatures: FzType.tabularNums,
  );
  // h1 (título de pantalla)
  static const h1 = TextStyle(
    fontFamily: FzType.sans, fontSize: 26, fontWeight: FontWeight.w600,
    letterSpacing: -0.65, color: FzColors.text,
  );
  // h2
  static const h2 = TextStyle(
    fontFamily: FzType.sans, fontSize: 20, fontWeight: FontWeight.w600,
    letterSpacing: -0.4, color: FzColors.text,
  );
  // monto en card
  static const amountLg = TextStyle(
    fontFamily: FzType.sans, fontSize: 24, fontWeight: FontWeight.w600,
    letterSpacing: -0.48, color: FzColors.text,
    fontFeatures: FzType.tabularNums,
  );
  // body
  static const body = TextStyle(
    fontFamily: FzType.sans, fontSize: 14, fontWeight: FontWeight.w400,
    color: FzColors.text, height: 1.4,
  );
  static const bodyM = TextStyle(
    fontFamily: FzType.sans, fontSize: 14, fontWeight: FontWeight.w500,
    color: FzColors.text,
  );
  static const bodyS = TextStyle(
    fontFamily: FzType.sans, fontSize: 13, fontWeight: FontWeight.w400,
    color: FzColors.text,
  );
  // caption
  static const caption = TextStyle(
    fontFamily: FzType.sans, fontSize: 12, fontWeight: FontWeight.w400,
    color: FzColors.textDim,
  );
  // mono (números, fechas)
  static const mono = TextStyle(
    fontFamily: FzType.mono, fontSize: 12, fontWeight: FontWeight.w500,
    letterSpacing: 0.48, color: FzColors.textDim,
  );
  ...
  static const caplabel = TextStyle(
    ...
    letterSpacing: 0.66, color: FzColors.textMute,
  );
}
...
class FzShadow {
  static List<BoxShadow> ctaPrimary = [
    BoxShadow(color: FzColors.primary.withOpacity(0.20), blurRadius: 16, offset: const Offset(0, 4)),
  ];
  static List<BoxShadow> hero = [
    BoxShadow(color: FzColors.primary.withOpacity(0.33), blurRadius: 30, offset: const Offset(0, 8)),
  ];
}
