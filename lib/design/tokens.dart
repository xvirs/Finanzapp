...
class FzColors {
  ...
  static const lateColor = Color(0xFFE5604A);
...
class FzColorsLight {
  ...
  static const lateColor = Color(0xFFC73A22);
}
...
class FzSpace {
  ...
  static const screenPadLg = 20.0;
  static const navBottom = 78.0;
}
...
class FzShadow {
  ...
  static List<BoxShadow> hero = [
    BoxShadow(
      color: FzColors.primary.withValues(alpha: 0.33),
      blurRadius: 30,
